...
arrays = {
    ...
    # Pre-convert coordinates to NumPy arrays BEFORE saving
    'x_coords': [np.array(lst) for lst in grid_with_data_df['x_coords']],
    'y_coords': [np.array(lst) for lst in grid_with_data_df['y_coords']],
}
